package Java.finalproject.jagadeesh;
...
public class WorkingFinalProject {
	 static String Path;
	    File myFolder;

	    public WorkingFinalProject() {
	   ...
	   private static final String WELCOME_TO_MY_COMPANY_PROTAL =
	           ...
	           "\n By MyCompany Pvt.Ltd "
	                     + " " +
	           "\n Developed By KANCHERLA JAGADEESH";
	...
	public static void main(String[] args) {
		 System.out.println(WELCOME_TO_MY_COMPANY_PROTAL); 
	        WorkingFinalProject menu = new  WorkingFinalProject();
	        menu.firstView();
